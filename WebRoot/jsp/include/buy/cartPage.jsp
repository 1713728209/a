    ...
    <table class="cart-list">
        ...
        <c:forEach items="${list}" var="item">
            <tr select="false" stock="${item.product.stock}" buy = "${item.number}" price-per="${item.product.nowPrice}" ciid="${item.id}">
                ...
                <td>
                    <img src="/Small/img/noselect.png" class="select-img">
                ...
                <td>
                    <div class="cart-change">
                        <a href="javascript:void(0);" class="cart-decrease cart-change-button">-</a>
                        <input value="${item.number}" class="item-num-input">
                        <a href="javascript:void(0);" class="cart-increase cart-change-button">+</a>
                    </div>
                </td>
                <td>
...
<div class="pagination pagination-centered" style="margin-left: 35%;">
	<li><a href="/Small/cartlist?pageIndex=1&uid=${uid}">首页</a></li>
	<li><a href="/Small/cartlist?pageIndex=${page.pageIndex-1}&uid=${uid}">上一页</a></li>
	<li><a href="/Small/cartlist?pageIndex=${page.pageIndex+1}&uid=${uid}">下一页</a></li>
	<li><a href="/Small/cartlist?pageIndex=${page.pageCount}&uid=${uid}">末页</a></li>
