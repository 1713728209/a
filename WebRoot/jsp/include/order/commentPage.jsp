...
<main class="comment">
    ...
    <div class="comment-right-detail">
        ...
        <div class="comment-time">
            ...
            <div class="comment-time-text">现在查看的是 您所购买商品的信息<br> 于${orderItem.order.createDate}下单购买了此商品</div>
        </div>
    </div>
    <div class="comment-bar clear">
        ...
        <div class="comment-bar-bottom">
        </div>
    </div>
    <div class="comment-form">
        <form class="inner-form" action="/Small/addComment" method="post">
            ...
            <table class="comment-table">
                ...
                <tr>
                    ...
                    <input type="hidden" name="oid" value="${orderItem.id}">
