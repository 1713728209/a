...
<div class="container">
    ...
    <div class="container" style="width:33.3%;float:left">
        ...
        <table class="table table-hover table-striped">
            ...
            <tbody>
             <c:forEach items="${all}" var="ti" varStatus="vs">
            	<c:if test="${ti.type=='1' }">
                <tr>
        ...
        <table class="table table-hover table-striped">
            ...
            <c:forEach items="${all}" var="ti" varStatus="vs">
                ...
                <tr>
                    ...
                    <td><a href="delete?id=${ti.id}" class="delete-button">
        ...
        <table class="table table-hover table-striped">
            ...
            <c:forEach items="${all}" var="ti" varStatus="vs">
                ...
                <tr>
                    <th scope="row">${ti.id}</th>
                    <td><%-- <img src="../../../${productImgDir}${ti.path}" height="50px"> --%></td>
                    <td><a href="delete?id=${ti.id}" class="delete-button"><span class="glyphicon glyphicon-trash"></span></a></td>
                </tr>
                </c:if>
            </c:forEach>
            </tbody>
...
<div class="pagination pagination-centered" style="margin-left: 35%;">
	<li><a href="/Small/imagelist?pageIndex=1&pid=${pid }">首页</a></li>
	<li><a href="/Small/imagelist?pageIndex=${page.pageIndex-1}&pid=${pid }">上一页</a></li>
	<li><a href="/Small/imagelist?pageIndex=${page.pageIndex+1}&pid=${pid }">下一页</a></li>
	<li><a href="/Small/imagelist?pageIndex=${page.pageCount}&pid=${pid }">末页</a></li>
