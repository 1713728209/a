...
<div class="container" >
    <ol class="breadcrumb">
        ...
        <li><a href="/Small/propertylist?cid=${property.category.id}">${property.category.name}</a></li>
		<li>${property.name}</li>
    </ol>
</div>
    ...
    <div class="row" >
        <div class="panel panel-default" style="width: 600px;margin:auto">
            ...
            <div class="panel-body">
                <form class="form-horizontal" method="get" id="add-form" action="edit">
                    <div class="form-group">
						...
						<input name="opt" value = "updateProperty" type="hidden">
                    </div>
                    <div class="form-group">
