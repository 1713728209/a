...
<div class="container" >
    <ol class="breadcrumb">
        ...
        <li><a href="/Small/propertylist?cid=${product.category.id}">${product.category.name}</a></li>
		<li>${product.name}</li>
    </ol>
</div>
    ...
    <div class="row" >
        <div class="panel panel-default" style="width: 600px;margin:auto">
            ...
            <div class="panel-body">
                <form class="form-horizontal" method="post" id="add-form" action="/Small/updateProduct">
