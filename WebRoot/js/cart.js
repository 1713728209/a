function changeSelect(tr) {
    ...
    if ($(tr).attr("select") === "false") {
        $(tr).find("td img.select-img").attr("src", "/Small/img/select.png");
        $(tr).attr("select", "true");
        $(tr).css("background-color", "#FFF8E1");
    } else if ($(tr).attr("select") === "true") {
        $(tr).find("td img.select-img").attr("src", "/Small/img/noselect.png");
...
function sumUpdate() {
    ...
    //如果全部选满
    if (result[2]) {
        $(".select-all").attr("src", "/Small/img/select.png");
    } else {
        $(".select-all").attr("src", "/Small/img/noselect.png");
    }
}
...
$(function () {
    ...
    $("#confirmDelete").click(function () {
        ...
        $.get("/Small/deleteCart",{"id":deleteCiid},function (result) {
            if(result === "success"){
